...
jsPsych.data = (function() {
  ...
  module.getInteractionData = function() {
	...
	//--- CREx add to add initial data (before start of the experiment)
  module.write_init = function(data_object){
    var default_data = {
      'type': data_object.type,
      'tG': 0
      };
    var ext_data_object = Object.assign({}, default_data, data_object);
  ...
  /*  var default_data = {
    ...
    // CREx / slightly reduce json data size
    var default_data = {
      'type': trial.type,
      'idx': progress.current_trial_global,
    ...
    var ext_data_object = Object.assign({}, default_data, dataProperties, data_object, trial.data);
